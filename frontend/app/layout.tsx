  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="theme-color" content="#ffbf1f" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="Portik" />
      ...
      <body className="min-h-screen bg-black text-slate-100">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 pb-8">
          <header className="sticky top-0 z-40 -mx-4 sm:-mx-6 mb-8 border-b border-slate-800/70 bg-black/55 px-4 sm:px-6 py-3 sm:py-4 backdrop-blur">
            <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
              <Link href="/" className="group flex items-center gap-2 text-base sm:text-lg font-semibold tracking-tight touch-manipulation">
